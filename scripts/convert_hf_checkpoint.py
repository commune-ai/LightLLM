...
from llama_model.model import LLaMA, LLaMAConfig
from llama_model.utils import EmptyInitOnDevice, lazy_load, incremental_save


@torch.no_grad()
def convert_hf_checkpoint(
    *,
    output_dir: Path = Path("checkpoints/lightllm/7B"),
    ...
    with incremental_save(output_dir / "lightllm.pth") as saver:
