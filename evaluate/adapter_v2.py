...
from llama_model.adapter import LLaMA
from llama_model.utils import EmptyInitOnDevice, lazy_load, llama_model_lookup
from llama_model.adapter_v2 import add_adapter_v2_parameters_to_linear_layers
...
def main(
    ...
    *,
    ...
    adapter_path: Path = Path("out/adapter_v2/alpaca/lightllm-adapter-finetuned.pth"),
    checkpoint_path: Path = Path("checkpoints/lightllm/7B/lightllm.pth"),
    tokenizer_path: Path = Path("checkpoints/lightllm/tokenizer.model"),
    dtype: str = "float32",
