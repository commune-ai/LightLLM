...
def _setup_args() -> Dict[str, Any]:
    ...
    return {
        ...
        "packages": find_packages(where="src", include=["lightning", "engine.*"]),
        "package_dir": {"": "src"},
        ...
        "entry_points": {
            "console_scripts": [
                "fabric = engine.fabric.cli:_main",
                "lightning = engine.fabric.cli:_legacy_main",
        ...
        "project_urls": {
            ...
            "Documentation": "https://engine.ai/lightning-docs",
