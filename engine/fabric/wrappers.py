...
import torch
from utilities import is_overridden
...
from engine.fabric.plugins import Precision
from engine.fabric.strategies import Strategy
from engine.fabric.utilities import move_data_to_device
from engine.fabric.utilities.data import _set_sampler_epoch
from engine.fabric.utilities.device_dtype_mixin import _DeviceDtypeModuleMixin
from engine.fabric.utilities.imports import _TORCH_GREATER_EQUAL_2_0
from engine.fabric.utilities.types import Optimizable
    ...
    def __init__(
        ...
        Args:
            ...
            original_module: The original, unmodified module as passed into the
                :meth:`fabric.fabric.Fabric.setup` method. This is needed when attribute lookup
