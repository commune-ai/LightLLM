...
if os.path.isfile(os.path.join(os.path.dirname(__file__), "__about__.py")):
    from engine.fabric.__about__ import *  # noqa: F403
if os.path.isfile(os.path.join(os.path.dirname(__file__), "__version__.py")):
    from engine.fabric.__version__ import version as __version__
elif package_available("engine"):
...
from engine.fabric.utilities.warnings import disable_possible_user_warnings  # noqa: E402
from engine.fabric.wrappers import is_wrapped  # noqa: E402
