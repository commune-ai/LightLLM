...
from utilities import apply_to_collection
from torch.nn import Module
from typing_extensions import override

from engine.fabric.accelerators.cpu import CPUAccelerator
from engine.fabric.strategies.launchers.launcher import _Launcher
from engine.fabric.utilities.apply_func import move_data_to_device
from engine.fabric.utilities.distributed import _set_num_threads_if_needed
from engine.fabric.utilities.imports import _IS_INTERACTIVE
from engine.fabric.utilities.seed import _collect_rng_states, _set_rng_states

if TYPE_CHECKING:
    from engine.fabric.strategies import ParallelStrategy
...
class _MultiProcessingLauncher(_Launcher):
    ...
    def launch(self, function: Callable, *args: Any, **kwargs: Any) -> Any:
        ...
        # The default cluster environment in engine chooses a random free port number
...
def _check_bad_cuda_fork() -> None:
    ...
    message = (
        "engine can't create new processes if CUDA is already initialized. Did you manually call"
