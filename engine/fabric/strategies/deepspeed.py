...
from engine.fabric.accelerators import Accelerator, CUDAAccelerator
...
from engine.fabric.strategies.ddp import DDPStrategy
from engine.fabric.strategies.registry import _StrategyRegistry
from engine.fabric.strategies.strategy import _Sharded
from engine.fabric.utilities.distributed import log
from engine.fabric.utilities.load import _move_state_into
from engine.fabric.utilities.rank_zero import rank_zero_info, rank_zero_warn
from engine.fabric.utilities.seed import reset_seed
from engine.fabric.utilities.types import _PATH
...
class DeepSpeedStrategy(DDPStrategy, _Sharded):
    ...
    def __init__(
        ...
        engine.readthedocs.io/en/stable/advanced/model_parallel.html#deepspeed`.
    ...
    def _format_config(self) -> None:
        if self.config is None:
            raise ValueError(
                ...
                " See: https://engine.ai/docs/pytorch/stable/advanced/model_parallel.html#deepspeed"
            )
