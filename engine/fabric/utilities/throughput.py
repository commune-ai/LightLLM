...
from engine.fabric.utilities.imports import _TORCH_GREATER_EQUAL_2_1
from engine.fabric.utilities.rank_zero import rank_zero_only, rank_zero_warn

if TYPE_CHECKING:
    from engine.fabric import Fabric
...
def get_available_flops(device: torch.device, dtype: Union[torch.dtype, str]) -> Optional[int]:
    ...
    if device.type == "cuda":
        ...
        if dtype is torch.float32:
            from engine.fabric.accelerators.cuda import _is_ampere_or_later
