...
from engine.fabric.utilities.rank_zero import _get_rank, rank_prefixed_message, rank_zero_only, rank_zero_warn
...
def seed_everything(seed: Optional[int] = None, workers: bool = False) -> int:
    ...
    Args:
        seed: the integer value seed for global random state in engine.
        ...
        workers: if set to ``True``, will properly configure all dataloaders passed to the
            ...
            :func:`~engine.fabric.utilities.seed.pl_worker_init_function`.
...
def reset_seed() -> None:
    r"""Reset the seed to the value that :func:`~engine.fabric.utilities.seed.seed_everything` previously set.

    If :func:`~engine.fabric.utilities.seed.seed_everything` is unused, this function will do nothing.
