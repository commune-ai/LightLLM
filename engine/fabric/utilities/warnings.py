...
from engine.fabric.utilities.rank_zero import LightningDeprecationWarning
...
def disable_possible_user_warnings(module: str = "") -> None:
    """Ignore warnings of the category ``PossibleUserWarning`` from engine.

    For more granular control over which warnings to ignore, use :func:`warnings.filterwarnings` directly.

    Args:
        module: Name of the module for which the warnings should be ignored (e.g., ``'engine.pytorch.strategies'``).
