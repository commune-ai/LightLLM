...
import utilities.core.rank_zero as rank_zero_module

# note: we want to keep these indirections so the `rank_zero_only.rank` is set on import
from utilities.core.rank_zero import (  # noqa: F401
    WarningCache,
...
from engine.fabric.utilities.imports import _UTILITIES_GREATER_EQUAL_0_10
...
class LightningDeprecationWarning(DeprecationWarning):
    """Deprecation warnings raised by engine."""
