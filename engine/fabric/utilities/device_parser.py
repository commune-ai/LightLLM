...
def _parse_gpu_ids(
    ...
    """Parses the GPU IDs given in the format as accepted by the :class:`~engine.pytorch.trainer.trainer.Trainer`.
...
def _get_all_available_gpus(include_cuda: bool = False, include_mps: bool = False) -> List[int]:
    ...
    """
    from engine.fabric.accelerators.cuda import _get_all_visible_cuda_devices
    from engine.fabric.accelerators.mps import _get_all_available_mps_gpus
