...
from utilities.core.inheritance import get_all_subclasses
...
from engine.fabric.utilities.exceptions import MisconfigurationException
from engine.fabric.utilities.rank_zero import rank_zero_warn
from engine.fabric.utilities.seed import pl_worker_init_function
...
def _reinstantiate_wrapped_cls(orig_object: Any, *args: Any, explicit_cls: Optional[Type] = None, **kwargs: Any) -> Any:
    ...
    try:
        ...
        message = (
            ...
            " This argument was automatically passed to your object by PyTorch engine."
        )
...
class AttributeDict(Dict):
    ...
    :meth:`~engine.fabric.fabric.Fabric.save` and :meth:`~engine.fabric.fabric.Fabric.load`.
