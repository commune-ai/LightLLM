...
from engine.fabric.accelerators import ACCELERATOR_REGISTRY
from engine.fabric.accelerators.accelerator import Accelerator
from engine.fabric.accelerators.cuda import CUDAAccelerator
from engine.fabric.accelerators.mps import MPSAccelerator
from engine.fabric.accelerators.xla import XLAAccelerator
from engine.fabric.plugins import (
...
from engine.fabric.plugins.environments import (
    ClusterEnvironment,
...
from engine.fabric.plugins.precision.double import DoublePrecision
from engine.fabric.plugins.precision.fsdp import FSDPPrecision
from engine.fabric.plugins.precision.precision import (
    _PRECISION_INPUT,
...
from engine.fabric.strategies.ddp import _DDP_FORK_ALIASES
from engine.fabric.strategies.fsdp import _FSDP_ALIASES, FSDPStrategy
from engine.fabric.utilities import rank_zero_info, rank_zero_warn
from engine.fabric.utilities.device_parser import _determine_root_gpu_device
from engine.fabric.utilities.imports import _IS_INTERACTIVE
    ...
    def _check_config_and_set_final_flags(
        ...
        if strategy != "auto" and strategy not in self._registered_strategies and not isinstance(strategy, Strategy):
            raise ValueError(
                ...
                " It must be either a string or an instance of `fabric.strategies.Strategy`."
