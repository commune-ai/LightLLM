...
from engine.fabric.utilities.logger import _add_prefix
...
class CSVLogger(Logger):
    ...
    Args:
        ...
        name: Experiment name. Defaults to ``'engine_logs'``. If name is ``None``, logs
    ...
    Example::
        ...
        from engine.fabric.loggers import CSVLogger
