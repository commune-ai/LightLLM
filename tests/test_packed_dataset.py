...
def test_packed_dataset(tmp_path):
    ...
    from llama_model.packed_dataset import PackedDatasetBuilder, PackedDataset, HDR_SIZE
...
def test_combined_dataset(tmp_path):
    from llama_model.packed_dataset import CombinedDataset
...
def test_sharded_packed_dataset(monkeypatch):
    import llama_model.packed_dataset
    from llama_model.packed_dataset import PackedDataset

    dataset_iterator_mock = MagicMock()
    monkeypatch.setattr(llama_model.packed_dataset, "PackedDatasetIterator", dataset_iterator_mock)
